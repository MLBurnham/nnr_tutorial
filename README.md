A brief introduction to image and audio classification with feed forward neural networks. I provide examples with both the neuralnet and Keras packages in R. 
